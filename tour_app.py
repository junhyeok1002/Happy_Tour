            ...
            with tabs[i]:
                ...
                with st.container():
                    ...
                    <table class = "first-day">
                      <tr style="color:#F0A23D ;background-color: white ;border-top: 0.3rem solid #F0A23D;border-right : 0.2rem solid #F0F2F6;">
                ...
                with st.container():
                    ...
                    <table class = "second-day">
                      <tr style="color:#B57200 ;background-color: white ;border-top: 0.3rem solid #B57200;border-right : 0.2rem solid #F0F2F6;">
                ...
                with st.container():
                    ...
                    <table class = "third-day">
                      <tr style="color:#8B4600 ;background-color: white ;border-top: 0.3rem solid #8B4600;border-right : 0.2rem solid #F0F2F6;">
